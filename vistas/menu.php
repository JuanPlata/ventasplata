...
<head>
  ...
  <link rel="shortcut icon" href="..\archivos\i8.png"> 
</head>
<body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" data-spy="affix" data-offset-top="100">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="inicio.php"><img class="img-responsive logo img-thumbnail" src="../archivos\b2.jpeg" alt="" width="130px" height="100px" ></a>
        </div>
